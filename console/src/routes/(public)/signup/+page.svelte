    ...
    <div  class="w-full mx-24">
        <form 
            ...
            <div class="flex flex-col relative">
                <label class="text-sm mb-1" for="name">Name</label>
                <Input id="name" type="text" name="name" placeholder="Name" required value={data.autofill_name}/>
            ...
            <div class="flex flex-col relative">
                ...
                <Input id="email" type="email" name="email" placeholder="Email" required value={data.autofill_email}/>
            ...
            <div class="flex flex-col relative">
                ...
                <Input id="password" type="password" name="password" placeholder="Password" required value={data.autofill_password}/>
            ...
            <div class="flex flex-col relative mb-8">
                ...
                <Input id="re-password" type="password" name="re_password" placeholder="Repeast password" required value={data.autofill_re_password}/>
