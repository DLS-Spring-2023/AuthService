...
<div class="project-container group relative">
    {#if data}
    ...
    {:else}
        <button type="button" on:click={onClick} class="w-full h-full flex flex-col justify-center items-center text-slate-100">
