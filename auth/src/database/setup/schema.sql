...
CREATE TABLE IF NOT EXISTS server_settings (allow_multiple_accounts tinyint DEFAULT 0 NOT NULL);
...
ALTER TABLE account ADD COLUMN IF NOT EXISTS enabled         tinyint      NOT NULL DEFAULT 1 ;
ALTER TABLE account ADD PRIMARY KEY IF NOT EXISTS            (id);


ALTER TABLE account_session ADD COLUMN IF NOT EXISTS id         bigint(20)   NOT NULL UNIQUE;           
...
ALTER TABLE user_session ADD COLUMN IF NOT EXISTS id         bigint(20)   NOT NULL UNIQUE;           
